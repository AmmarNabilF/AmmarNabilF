...
Original file is located at
    https://colab.research.google.com/drive/1Zk-AfJ2GZSLYYVhMWh4UeHFMNe1H7Al2
"""
    ...
    """)
            ...
            if pilihan5 == "1": #LOGIN MEMBER
                ...
                while not is_login_successful:
                    print("##_MASUKKAN AKUN MEMBER ANDA_##")
                    user = str(input("Username: "))
                    pw = str(input("Password: "))
                    if user in member_acc and pw == member_pw[member_acc.index(user)]:
                        print(f"Hai memberku, {user}")
